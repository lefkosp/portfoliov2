    ...
    <section className="flex min-h-screen w-full items-center px-6 lg:px-margin-edge">
      <div className="grid w-full grid-cols-4 gap-gutter lg:grid-cols-12">
        ...
        <div className="relative z-10 col-span-4 flex flex-col gap-8 lg:col-span-8">
          ...
          >
            LEFKOS <br />
            <span className="text-surface-variant">PAPAPETROU</span>
          </h1>
        ...
        >
          ...
          <div className="absolute left-1/2 top-1/2 origin-center -translate-x-1/2 -translate-y-1/2 -rotate-90 whitespace-nowrap font-mono text-technical-mono text-surface-variant opacity-50">
            SYS.ARCH_GRID_V1
          </div>
        </div>
      </div>
